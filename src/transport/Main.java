...
//        System.out.println(hyundai);
        ...
        Car.Insurance ladaIns = new Car.Insurance("21.09.2022", 5002.25, "МММ256321");
        lada.setInsurance(ladaIns);
        System.out.println(lada);
        Car.Insurance audiIns = new Car.Insurance("21.12.2022", 15035.25, "МCC256352");
        audi.setInsurance(audiIns);
        System.out.println(audi);
        Car.Insurance bmwIns = new Car.Insurance("15.05.2022", 15112.72, "МXX234444");
        bmw.setInsurance(bmwIns);
        System.out.println(bmw);
        Car.Insurance kiaIns = new Car.Insurance("01.06.2022", 15102.50, "АВВ223546");
        kia.setInsurance(kiaIns);
        System.out.println(kia);
        Car.Insurance hyundaiIns = new Car.Insurance("03.12.2022", 7856.25, "ВВВ256");
